...
import TransactionsList from 'routes/TransactionsList/TransactionsList';
import { ErrorBoundary } from 'components/ErrorBoundary';
import { ErrorFallback } from 'components/ErrorFallback';
import { HealthCheck } from 'components/HealthCheck';
import { CourtesyPage } from 'routes/CourtesyPage/CourtesyPage';
import Login from 'routes/Login/Login';
import Assistance from 'routes/Assistance/Assistance';
import { PaymentNotices } from 'routes/PaymentNotices/PaymentNotices';
import PaymentNoticeDetail from 'routes/PaymentNoticeDetail/PaymentNoticeDetail';
