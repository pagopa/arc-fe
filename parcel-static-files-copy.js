/* I copied this file from parcel-reporter-static-files-copy parcel plugin because
I wanted to add support for .env file to read environment variables.
original plugin: https://www.npmjs.com/package/parcel-reporter-static-files-copy
*/

"use strict";
require('dotenv').config(); // I added this line to read .env file
